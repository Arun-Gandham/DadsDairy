          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="avatar avatar-online">
                <img src="{{ Auth::user() ? asset('assets/img/avatars/1.png') : '' }}" alt class="h-auto rounded-circle">
              </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
              <li>
              ...
              @if (Auth::check() && Auth::user()->hasPermission('view_api_tokens'))
              <li>
              ...
              @if (Auth::user() && Auth::user()->hasPermission('manage_teams'))
              <li>
                <div class="dropdown-divider"></div>
              </li>
              <li>
              ...
              @if (Auth::user()->can('create', App\Models\Team::class))
              <li>
