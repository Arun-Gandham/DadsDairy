...
<div class="our-scrolling-ticker">
        <div class="scrolling-ticker-box">
            <div class="scrolling-content">
                ...
                <span><img src="{{ asset('assets/customer/images/icon-sparkle.svg') }}" alt="">pot curd</span>
                <span><img src="{{ asset('assets/customer/images/icon-sparkle.svg') }}" alt="">country egg</span>
                <span><img src="{{ asset('assets/customer/images/icon-sparkle.svg') }}" alt="">cow ghee</span>
                <span><img src="{{ asset('assets/customer/images/icon-sparkle.svg') }}" alt="">buffalo ghee</span>
                <span><img src="{{ asset('assets/customer/images/icon-sparkle.svg') }}" alt="">Milk</span>
                <span><img src="{{ asset('assets/customer/images/icon-sparkle.svg') }}" alt="">pot curd</span>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="our-product-box owl-carousel owl-theme">
                    ...
                    <div class="product-item">
                        <img src="{{ asset('assets/customer/img/product-5.jpg') }}" alt="Cow Ghee">
                        <div class="product-overlay">
                            <h2>Buffalo Ghee</h2>
                            <p>Pure cow ghee, rich aroma and high quality.</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 order-lg-1 order-1">
                    ...
                    <div class="why-choose-box">
                        ...
                        <div class="why-choose-item wow fadeInUp">
                            <!-- Icon Box Start -->
                            <div class="icon-box">
                                <img src="{{ asset('assets/customer/images/icon-why-choose-1.svg') }}" alt="">
                            </div>  
                            <!-- Icon Box End -->
                        ...
                        <div class="why-choose-item wow fadeInUp" data-wow-delay="0.2s">
                            <!-- Icon Box Start -->
                            <div class="icon-box">
                                <img src="{{ asset('assets/customer/images/icon-why-choose-2.svg') }}" alt="">
                            </div>  
                            <!-- Icon Box End -->
                        ...
                        <div class="why-choose-item wow fadeInUp" data-wow-delay="0.4s">
                            <!-- Icon Box Start -->
                            <div class="icon-box">
                                <img src="{{ asset('assets/customer/images/icon-why-choose-3.svg') }}" alt="">
                            </div>  
                            <!-- Icon Box End -->
                ...
                <div class="col-lg-4 col-md-6 order-lg-3 order-2">
                    ...
                    <div class="why-choose-box">
                        ...
                        <div class="why-choose-item wow fadeInUp">
                            <!-- Icon Box Start -->
                            <div class="icon-box">
                                <img src="{{ asset('assets/customer/images/icon-why-choose-4.svg') }}" alt="">
                            </div>  
                            <!-- Icon Box End -->
                        ...
                        <div class="why-choose-item wow fadeInUp" data-wow-delay="0.2s">
                            <div class="icon-box">
                                <img src="{{ asset('assets/customer/images/icon-why-choose-5.svg') }}" alt="">
                            </div>
                            <div class="why-choose-content">
                        ...
                        <div class="why-choose-item wow fadeInUp" data-wow-delay="0.4s">
                            <div class="icon-box">
                                <img src="{{ asset('assets/customer/images/icon-why-choose-6.svg') }}" alt="">
                            </div>
                            <div class="why-choose-content">
                ...
                <div class="col-lg-12">
                    <div class="intro-video-box">
                        <div class="video-play-circle">
                            <a href="https://www.youtube.com/watch?v=Y-x0efG1seA" class="popup-video" data-cursor-text="Play"><img src="{{ asset('assets/customer/images/video-play-circle.svg') }}" alt=""></a>
                        </div>
                        <div class="intro-video-item-list">
                            <div class="intro-video-item wow fadeInUp">
                                <div class="icon-box">
                                    <img src="{{ asset('assets/customer/images/icon-intro-video-1.svg') }}" alt="">
                                </div>
                            ...
                            <div class="intro-video-item wow fadeInUp" data-wow-delay="0.25s">
                                <div class="icon-box">
                                    <img src="{{ asset('assets/customer/images/icon-intro-video-2.svg') }}" alt="">
                                </div>
                                <div class="intro-video-content">
                            ...
                            <div class="intro-video-item wow fadeInUp" data-wow-delay="0.5s">
                                <div class="icon-box">
                                    <img src="{{ asset('assets/customer/images/icon-intro-video-3.svg') }}" alt="">
                                </div>
                                <div class="intro-video-content">
                    ...
                    <div class="about-us-content">
                        ...
                        <div class="about-item-box wow fadeInUp" data-wow-delay="0.6s">
                            <div class="about-us-item">
                                <div class="icon-box">
                                    <img src="{{ asset('assets/customer/images/icon-about-us-item-1.svg') }}" alt="">
                                </div>
                            ...
                            <div class="about-us-item">
                                <div class="icon-box">
                                    <img src="{{ asset('assets/customer/images/icon-about-us-item-2.svg') }}" alt="">
                                </div>
                                <div class="about-us-item-content">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-item">
                                            <div class="testimonial-company-logo">
                                                <img src="{{ asset('assets/customer/images/company-logo-1.svg') }}" alt="">
                                            </div>             
                                            ...
                                            <div class="testimonial-author">
                                                <div class="author-image">
                                                    <figure class="image-anime">
                                                        <img src="{{ asset('assets/customer/images/author-1.jpg') }}" alt="">
                                                    </figure>
                                                </div>            
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-item">
                                            ...
                                            <div class="testimonial-author">
                                                <div class="author-image">
                                                    <figure class="image-anime">
                                                        <img src="{{ asset('assets/customer/images/author-2.jpg') }}" alt="">
                                                    </figure>
                                                </div>            
                                                <div class="author-content">
                                                    <h3>Title comes here</h3>
